...
final class RTTEstimatorTest extends TestCase
{
    ...
    public function testUpdateRtt_withValidSample(): void
    {
        $rttSample = 200.0;
    ...
    public function testUpdateRtt_withAckDelay(): void
    {
        $rttSample = 300.0;
        $ackDelay = 50.0;
    ...
    public function testUpdateRtt_multipleUpdates(): void
    {
        // 第一次更新
    ...
    public function testUpdateRtt_updatesMinRtt(): void
    {
    ...
    public function testUpdateRtt_withZeroSample_throwsException(): void
    {
    ...
    public function testUpdateRtt_withNegativeSample_throwsException(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('RTT样本必须大于0');
    ...
    public function testCalculatePto_withDefaultPtoCount(): void
    {
    ...
    public function testCalculatePto_withPtoCount(): void
    {
        $ptoCount = 2;
    ...
    public function testCalculatePto_withNegativePtoCount_throwsException(): void
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testGetMinRtt_enforcesMinimum(): void
    {
        // 创建一个极小初始RTT的估算器
    ...
    public function testReset_resetsAllValues(): void
    {
        // 先更新一些值
    ...
    public function testGetStats_returnsCompleteInformation(): void
    {
    ...
    public function testGetStats_tracksampleCount(): void
    {
    ...
    public function testAckDelayHandling_withLargeDelay(): void
    {
        $rttSample = 100.0;
    ...
    public function testAckDelayHandling_preventsBelowMinRtt(): void
    {
        // 先设置一个较小的minRtt
