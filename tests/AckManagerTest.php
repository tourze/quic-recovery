...
final class AckManagerTest extends TestCase
{
    ...
    public function testOnPacketReceived_nonAckEliciting(): void
    {
        $packetNumber = 1;
        $receiveTime = 1000.0;
    ...
    public function testOnPacketReceived_outOfOrder(): void
    {
        // 先接收包5
    ...
    public function testOnPacketReceived_duplicatePacket(): void
    {
        $packetNumber = 1;
        $receiveTime = 1000.0;
    ...
    public function testOnPacketReceived_withNegativePacketNumber_throwsException(): void
    {
    ...
    public function testGenerateAckFrame_singlePacket(): void
    {
        $this->ackManager->onPacketReceived(1, 1000.0, true);
    ...
    public function testGenerateAckFrame_multiplePackets(): void
    {
        // 接收连续的包1-5
        for ($i = 1; $i <= 5; $i++) {
            $this->ackManager->onPacketReceived($i, 1000.0 + $i, true);
    ...
    public function testGenerateAckFrame_withGaps(): void
    {
        // 接收包1,2,3,7,8,9
        $this->ackManager->onPacketReceived(1, 1000.0, true);
    ...
    public function testGenerateAckFrame_emptyPackets(): void
    {
    ...
    public function testDetectMissingPackets_noLargestReceived(): void
    {
        $missingPackets = $this->ackManager->detectMissingPackets();
